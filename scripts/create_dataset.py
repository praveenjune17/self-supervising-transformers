...
for split in ['train', 'validation']:
    ...
    record_file_path = f'{config.tfds_name}_{split}.tfrecords'
    download_and_encode(record_file_path, source_tokenizer, target_tokenizer, split)
    datasets[split] = preprocess_dataset(record_file_path=record_file_path,
