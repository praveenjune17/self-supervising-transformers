...
to_be_flaked_directory_path = input("Enter the path of the modified scripts directory :")#'C:/Users/Vinodhkumar/self-supervising-transformers/scripts/'
existing_cloned_directory_path = input("Enter the path of the unchanged scripts directory :")#'C:/Users/Vinodhkumar/self-supervising-transformers - Copy/scripts'
