  ...
  "embeddings": [
    {
      ...
      "tensorPath": "https://raw.githubusercontent.com/praveenjune17/self-supervising-transformers/master/Visualize/embedding_projector_files/vecs_'''+str(filename)+'''.tsv",
      "metadataPath": "https://raw.githubusercontent.com/praveenjune17/self-supervising-transformers/master/Visualize/embedding_projector_files/meta_'''+str(filename)+'''.tsv"
    }
  ]
}''')
